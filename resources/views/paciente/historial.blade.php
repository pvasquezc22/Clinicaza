            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-4">
                        ...
                        <label class="control-label">Carnet de identidad : </label>{{ $paciente->carnet }}<br/>
                    ...
                    <div class="col-md-4 col-md-offset-1">
                        ...
                        <label class="control-label">Celular : </label>@if(isset($paciente->celula)) {{ $paciente->telefono }} @else - @endif<br/>
