						...
						<table class="table table-bordered">
							<thead>
								<tr>
									...
									?>
									<th style="vertical-align: center;text-align: center;" colspan="2">
										{{$enfermedad->nombre}}
										<br/>
										{{round(($enfermedad->diagnosticosCount()/$enfermedades_diagnosticadas)*10000)/100}} %
									</th>
									@endforeach
								</tr>
							</thead>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body" align='center'>
										<h2 id="modalDiagnosticoBodyEspecialidad"></h2>
										<input id='id_especialidad' style='display:none;'/>
										<br/>
										<button id='modalDiagnosticoBodyDiagnostico' class='btn btn-info btn-lg'></button>
										<br/><br/>
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-success" onclick="realizar_reserva()">Realizar reserva</button>
		...
		if(sintoma_array.length>2){
			$.ajax({
				...
				success: function( msg ) {
					$("#id_especialidad").val(msg['especialidad']['id']);
					$("#modalDiagnosticoBodyEspecialidad").html("Solicite ficha para " + msg['especialidad']['nombre']);
					$("#modalDiagnosticoBodyDiagnostico").html("Diagnostico presuntivo<br/>" + msg['enfermedad_estimada']['nombre']);
